...
void setup() {
  ...
  for (cal_int = 0; cal_int < 1250; cal_int++) {  //รอ 5 วินาทีก่อนดำเนินการต่อ
    PORTD |= B01111000;                           // ตั้งค่าดิจิตอลที่ไม่ดี 3, 4, 5 และ 6 สูง
    delayMicroseconds(1000);                      //รอ 1000us.
    PORTD &= B000011110;                           // ตั้งค่าดิจิตอลที่ไม่ดี 3, 4, 5 และ 6 ต่ำ
  ...
  while (receiver_input_channel_3 < 990 || receiver_input_channel_3 > 1020 || receiver_input_channel_4 < 1400) {
    ...
    PORTD |= B01111000;                    //ตั้งค่าดิจิตอลที่ไม่ดี 4, 5, 6 และ 7 สูง
    delayMicroseconds(1000);               //รอ 1000us.
    PORTD &= B000011110;                    //ตั้งค่าดิจิตอลที่ไม่ดี 4, 5, 6 และ 7 ต่ำ
    delay(3);                              //รอ 3 มิลลิวินาทีก่อนที่จะวนรอบถัดไป
...
void loop() {
  ...
  PORTD |= B01111000;                    // ตั้งค่าเอาต์พุตดิจิตอลสูง 4,5,6 และ 7
